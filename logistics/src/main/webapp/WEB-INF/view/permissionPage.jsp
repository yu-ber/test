...
function operationFormatter(value,row,index){
	console.log(index);
	var html="";
	html +="<shiro:hasPermission name='permission:update'>"
	html +="<span onclick='permission_edit("+value+");' style='color: green;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;&nbsp";
	html +="</shiro:hasPermission>"
	html +="<shiro:hasPermission name='permission:delete'>"
	html +="<span onclick='permission_del("+value+");' style='color: black;cursor: pointer;' class='glyphicon glyphicon-trash'></span>";
	html +="</shiro:hasPermission>"
	return html;			
}
...
function permission_add(){
	layer_show("权限添加","permission/edit.do",800,500);
}

/*权限-编辑*/
function permission_edit(permissionId){
	layer_show("权限修改","permission/edit.do?permissionId="+permissionId,800,500);
}
