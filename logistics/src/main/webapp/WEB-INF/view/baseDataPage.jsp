		...
		*/
		...
		columns: [ //表格显示数据对应的表头设置，
			...
			*/
			...
			{field: 'baseName',title: '基础数据名'}, 
			{field: 'baseDesc',title: '基础数据描述'},
...
function operationFormatter(value,row,index){
	...
	html +="<span onclick='baseData_edit("+value+");' style='color: green;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;&nbsp";
	html +="<span onclick='baseData_del("+value+");' style='color: black;cursor: pointer;' class='glyphicon glyphicon-trash'></span>";
...
function baseData_add(){
	layer_show("基础数据添加","baseData/edit.do",800,500);
}

/*基础数据-编辑*/
function baseData_edit(baseId){
	layer_show("基础数据修改","baseData/edit.do?baseId="+baseId,800,500);
}
