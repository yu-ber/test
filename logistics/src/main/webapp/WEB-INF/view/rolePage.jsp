		...
		*/
		...
		columns: [ //表格显示数据对应的表头设置，
			...
			*/
			...
			{field: 'remark',title: '角色介绍'},
			{field: 'permissionIds',title: '所拥有的权限'},
			//操作列的设置（删除，修改）
			/*
...
function operationFormatter(value,row,index){
	...
	html +="<span onclick='role_edit("+value+");' style='color: green;cursor: pointer;' class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;&nbsp;&nbsp";
	html +="<span onclick='role_del("+value+");' style='color: black;cursor: pointer;' class='glyphicon glyphicon-trash'></span>";
...
/*角色-增加*/
function role_add(){
	layer_show("角色添加","role/edit.do",800,500);
}

/*角色-编辑*/
function role_edit(roleId){
	layer_show("角色修改","role/edit.do?roleId="+roleId,800,500);
}
