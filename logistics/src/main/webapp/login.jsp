...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="admin/login.do" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="verifyCodeImg" style="cursor: pointer;" onclick="changeVerifyCode();" title="看不清，换一张" src="verifyCode.jsp"></div>
      </div>
...
<div class="footer">613xxx科技有限公司</div>
